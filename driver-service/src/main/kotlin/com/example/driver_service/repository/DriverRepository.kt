...
interface DriverRepository {
    ...
    @Insert("""INSERT INTO driver_table (id, name, email, phone_number, gender, car_id, work_status, created_at, updated_at) VALUES (#{id}, #{name}, #{email}, #{phoneNumber}, #{gender}, #{carId}, #{workStatus}, NOW(), NOW())""")
