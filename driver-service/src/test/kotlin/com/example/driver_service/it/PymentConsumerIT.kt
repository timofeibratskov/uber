...
//    ]
//)
//class PaymentConsumerIT @Autowired constructor(
...
//    private lateinit var rideTopic: String
//
//    @BeforeEach
//    fun cleanTable() {
...
//
//    @Test
//    @DisplayName("Консьюмер должен получить PAYMENT_AUTHORIZED, найти водителя и записать ASSIGNED_DRIVER в outbox")
//    fun testPaymentAuthorizedEventWithDriverFound() {
//        // Arrange
...
//
//        val event = DriverSearchingEvent(
//            rideId = rideId,
//            startPoint = point,
//            seats = 4
//        )
...
//
//        val record = ProducerRecord<String, String>(rideTopic, payload)
//        record.headers().add("eventType", EventType.PAYMENT_AUTHORIZED.eventName.toByteArray())
//
//        // Act
...
//
//                val outboxList = outboxEventRepository.findAllByOrderByCreatedAt()
//
//                assertNotNull(outboxList, "Outbox list should not be null")
//                assertTrue(outboxList.isNotEmpty(), "Outbox should contain at least one event")
...
//                assertEquals(rideTopic, outbox.topic)
...
//
//    @Test
//    @DisplayName("Консьюмер должен получить PAYMENT_AUTHORIZED, НЕ найти водителя и записать NO_AVAILABLE_DRIVERS в outbox")
